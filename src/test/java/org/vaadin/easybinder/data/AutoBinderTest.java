...
public class AutoBinderTest {
    ...
    public void testBuildAndBindWithListOfNestedProperties() {
        ...
        assertNull(ComponentUtil.getData(numberField, "error"));
        numberField.setValue("0");
        assertNotNull(ComponentUtil.getData(numberField, "error"));
        ...
        assertNotNull(ComponentUtil.getData(numberField2, "error"));
    }
